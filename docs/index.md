...
form-driven page editor are all shipping. **Sixteen panels are
confirmed on real hardware**: the Seeed reTerminal E1001, E1002,
E1003, E1004 and Sticky, the Seeed XIAO 13.3" ePaper EE02, and the
M5Stack M5Paper and PaperMono on the Tesserae-native firmware
(browser flash, battery-powered), the Seeed
