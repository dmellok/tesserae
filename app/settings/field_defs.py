...
PANEL_FIELDS: list[dict[str, Any]] = [
    ...
    },
    {
        "name": "panel_w",
        "type": "slider",
        "label": "Logical panel width (px)",
        "default": 1600,
        "min": 100,
        "max": 3000,
        "step": 1,
        "unit": "px",
        "help": "Only used when Panel size is Custom. Composition orientation, not the physical size the device reports.",
    },
    {
        "name": "panel_h",
        "type": "slider",
        "label": "Logical panel height (px)",
        "default": 1200,
        "min": 100,
        "max": 3000,
        "step": 1,
