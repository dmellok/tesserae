...
function renderR1(data) {
  ...
  return `
    ...
    <style>
      ...
      .wn-r1-sun-cell:first-child { background:var(--wx-tint-yellow); }
      .wn-r1-sun-cell:last-child { background:var(--wx-tint); }
      .wn-r1-sun-cell + .wn-r1-sun-cell { border-left:1px solid var(--c-line); }
      .wn-r1-sun-time { margin-left:auto; font-weight:700; font-size:clamp(11px, 2cqw, 14px); color:var(--c-accent); }
